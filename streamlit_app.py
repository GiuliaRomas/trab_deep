...
def inicializa(openai_api_key):
    ...
    Sempre especifique o número da lei ou do estatuto em que os artigos se encontram.
    Se possível, especifique o nome da lei ou do estatuto em que os artigos se encontram.
...
with st.form('my_form'):
    ...
    if submitted and openai_api_key.startswith('sk-'):
        ...
        .justificado {
            text-align: justify;
                border-bottom: 2px solid transparent; /* Borda na parte inferior sem cor */
                padding-bottom: 20px; /* Aumenta a distância da borda inferior */
